(function (window, undefined) {
    ...
    MapsLib.prototype.doSearch = function () {
        ...
        var type_column = "'winner'";
        var tempWhereClause = [];
        if ( $("#cbType1").is(':checked')) tempWhereClause.push("Emmanuel Macron");
        if ( $("#cbType2").is(':checked')) tempWhereClause.push("Marine Le Pen");
    ...
    MapsLib.prototype.displaySearchCount = function (json) {
        ...
        $("#result_box").fadeOut(function () {
            $("#result_count").html(self.addCommas(numRows) + " villes" + " trouvées");
        });
        $("#result_box").fadeIn();
    };
